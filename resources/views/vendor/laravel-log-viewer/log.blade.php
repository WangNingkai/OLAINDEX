...
<head>
  ...
  <link rel="stylesheet"
    href="https://cdn.staticfile.net/bootswatch/4.5.0/{{ setting('site_theme', 'lux') }}/bootstrap.min.css">
  <link rel="stylesheet" type="text/css"
    href="https://cdn.staticfile.net/datatables/1.10.20/css/dataTables.bootstrap4.min.css">
  <style>
    body {
      padding: 25px;
    }
...
<body>
  ...
  <script src="https://cdn.staticfile.net/jquery/3.5.1/jquery.slim.min.js"></script>
  <script src="https://cdn.staticfile.net/twitter-bootstrap/4.5.0/js/bootstrap.min.js"></script>
  <!-- FontAwesome -->
  <script defer src="https://cdn.staticfile.net/font-awesome/5.13.0/js/all.min.js"></script>
  <!-- Datatables -->
  <script type="text/javascript"
    src="https://cdn.staticfile.net/datatables/1.10.20/js/jquery.dataTables.min.js"></script>
  <script type="text/javascript"
    src="https://cdn.staticfile.net/datatables/1.10.20/js/dataTables.bootstrap4.min.js"></script>
