    ...
    <div class="card border-light mb-3">
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                <a href="{{ route('download',urlencode($origin_path)) }}" class="btn btn-success"><i class="fa fa-download"></i> 下载</a>
                &nbsp;&nbsp;
                <a href="{{ route('view',urlencode($origin_path)) }}"  data-fancybox="image-list" class="btn btn-info"><i class="fa fa-eye"></i>
                    点击查看原图</a>
            </div>
            <hr>
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    <input type="text" id="link1" class="form-control" aria-label="Amount (to the nearest dollar)"
                           value="{{ route('view',urlencode($origin_path)) }}">
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    <input type="text" id="link3" class="form-control" aria-label="Amount (to the nearest dollar)"
                           value="<img src='{{ route('view',urlencode($origin_path)) }}' />">
                    <div class="input-group-append">
                        <a href="javascript:void(0)" style="text-decoration: none" data-toggle="tooltip"
