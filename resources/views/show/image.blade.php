    ...
    <div class="card border-light mb-3">
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                <a href="{{ route('download',\App\Helpers\Tool::handleUrl($origin_path)) }}" class="btn btn-success"><i class="fa fa-download"></i> 下载</a>
                &nbsp;&nbsp;
                <a href="{{ route('view',\App\Helpers\Tool::handleUrl($origin_path)) }}"  data-fancybox="image-list" class="btn btn-info"><i class="fa fa-eye"></i>
                    点击查看原图</a>
            </div>
            <hr>
