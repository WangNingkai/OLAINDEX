    ...
    <div class="card border-light mb-3">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        <input type="text" id="link1" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{ route('view',$file['id']) }}">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        <input type="text" id="link2" class="form-control" aria-label="Amount (to the nearest dollar)" value="![]({{ route('view',$file['id']) }})">
                        <div class="input-group-append">
                            <a href="javascript:void(0)" style="text-decoration: none" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        <input type="text" id="link3" class="form-control" aria-label="Amount (to the nearest dollar)" value="<img src='{{ route('view',$file['id']) }}' />">
                        <div class="input-group-append">
                            <a href="javascript:void(0)" style="text-decoration: none" data-toggle="tooltip"
