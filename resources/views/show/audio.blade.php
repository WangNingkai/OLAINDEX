...
@section('content')
    ...
    <div class="card border-light mb-3">
        ...
        <div class="card-body">
            <div class="text-center"><a href="{{ $file['download'] }}" class="btn btn-success"><i
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    <input type="text" id="link1" class="form-control" aria-label="Amount (to the nearest dollar)"
                           value="{{ route('download',$origin_path ? $origin_path.'/'.$file['name'] : $file['name']) }}">
    ...
    <script>
        const ap = new APlayer({
            ...
            audio: [{
                name: "{{ $file['name'] }}",
                artist: 'unknown',
                url: "{{ route('download',$origin_path ? $origin_path.'/'.$file['name'] : $file['name']) }}",
