            ...
            <div class="list-group item-list">
                @foreach($items as $item)
                    <li class="list-group-item list-group-item-action">
                        <div class="row">
                            <div class="col">
                                <a href="{{ route('show',urlencode(id2path($item['id']))) }}"
                                   title="{{ $item['name'] }}">
                            ...
                            <div class="col d-none d-md-block d-md-none">
                                <span class="pull-right">
                                    <a href="{{ route('download',urlencode(id2path($item['id']))) }}"><i
                                            class="fa fa-download"
                                            title="下载"></i></a>&nbsp;&nbsp;
                                    <a href="javascript:void(0)"
                                       data-clipboard-text="{{ route('download',urlencode(id2path($item['id']))) }}"
                                       class="clipboard"
