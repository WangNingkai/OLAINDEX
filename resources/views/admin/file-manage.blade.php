                        ...
                        @foreach ($path as $key => $value)
                            ...
                            @else
                                @if (!blank($value))
                                    <li class="breadcrumb-item ">
                                        <a
                                            href="{{ route('manage.query', ['account_id' => $account_id, 'query' => url_encode(\App\Helpers\Tool::combineBreadcrumb($key + 1, $path))]) }}">
                                            {{  str_limit($value, 20) }}
                                        </a>
                                    </li>
                                @endif
                    ...
                    <tbody>
                        ...
                        @else
                            @foreach($list as $data)
                                <tr class="list-item align-items-center" data-id="{{ $data['id'] }}"
                                    data-name="{{ $data['name'] }}" data-file="{{ !array_has($data, 'folder') }}"
                                    data-size="{{ $data['size'] }}"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="uploader m-3"><input type="file" class="filepond" name="filepond"></div>
...
@stop
@push('stylesheet')
    <link rel="stylesheet" href="https://cdn.staticfile.net/filepond/4.23.1/filepond.min.css">
@endpush
@push('scripts')
    <script src="https://cdn.staticfile.net/filepond/4.23.1/filepond.min.js"></script>
    <script>
