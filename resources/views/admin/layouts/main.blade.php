                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <span class="avatar avatar-sm"
                                style="background-image: url({{ asset('img/log.svg') }})"></span>
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="//github.com/WangNingkai/OLAINDEX/issues/new/choose" target="_blank"
                                        class="link-secondary">反馈</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="https://github.com/wangningkai/olaindex" target="_blank"
                                        class="link-secondary" rel="noopener">源码</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="https://github.com/wangningkai/olaindex" target="_blank"
                                        class="link-secondary" rel="noopener">v6.0</a>
                                </li>
                            </ul>
                        </div>
                    </div>
