...
@section('content')
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <span class="form-text text-danger">要显示的图片后缀, 空格隔开</span>
        </div>
        <div class="form-group">
            ...
            <span class="form-text text-danger">要显示的视频后缀, 空格隔开</span>
        </div>
        <div class="form-group">
            ...
            <span class="form-text text-danger">要显示的音频后缀, 空格隔开</span>
        </div>
        <div class="form-group">
            ...
            <span class="form-text text-danger">要显示的文档后缀, 空格隔开</span>
        </div>
        <div class="form-group">
            ...
            <span class="form-text text-danger">要显示的代码后缀, 空格隔开</span>
        </div>
        <div class="form-group">
            ...
            <span class="form-text text-danger">要显示的文本后缀, 空格隔开</span>
        </div>
