...
@section('content')
    <div class="card border-light mb-3 shadow">
        ...
        <div class="card-body table-responsive">
            <div class="row">
                <div class="col">
                    <a class="btn btn-sm btn-primary mb-0 mr-2 my-1" href="{{ route('install') }}" target="_blank"><i
                            class="ri-add-fill"></i>
                        新增账号</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button id="actionAccount" type="button"
