...
<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="{{ route('onedrive') }}">{{ getAdminConfig('name') }}</a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('onedrive') }}"><i class="fa fa-home"></i> 首页</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.onedrive.apply', ['onedrive' => $oneDrive->id]) }}" method="POST" target="_blank">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="redirect_uri" name="redirect_uri" value="{{ route('callback', ['oneDrive' => $oneDrive->id]) }}">
