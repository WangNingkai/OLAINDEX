    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="text-info">状态: {{ Tool::getOneDriveInfo('state') }} &nbsp;&nbsp;</span><br/>
                    <span class="text-danger">已使用: {{ Tool::getOneDriveInfo('used') }} &nbsp;&nbsp;</span><br/>
                    <span class="text-warning">剩余: {{ Tool::getOneDriveInfo('remaining') }} &nbsp;&nbsp;</span><br/>
